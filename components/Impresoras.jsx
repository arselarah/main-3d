...
export default function Impresoras() {
  ...
  const escalar = useTransform(scrollYProgress, [0, 1], [0.9, 2.5])
  return (
    <section
    ...
    >
      ...
      >
        {/* <motion.div
          className='relative h-96 w-96 rounded-full bg-red-400'
          style={{ translateY: mover }}
        /> */}
        <motion.div
        ...
        />
        <motion.div
          className='sticky top-1/3 z-[1] flex w-full justify-center bg-fondo_claro py-2 lg:w-[25%]'
